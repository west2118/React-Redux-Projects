    ...
    const sendRequest = async () => {
      try {
        const response = await fetch(
          "https://cart-practice-f8e66-default-rtdb.firebaseio.com/booksContacts.json",
          {
            method: "POST",
            headers: {
    ...
    <div className="mt-12 mb-72">
      <div className="grid sm:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-4xl  bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md font-[sans-serif]">
        ...
        <form onSubmit={handleSubmit} className="ml-auo space-y-4">
          ...
          <button className="text-white bg-blue-500 hover:bg-blue-600 rounded-md text-sm px-4 py-2.5 w-full !mt-6">
            Send
          </button>
        </form>
      </div>
